...
object OverlayRenderer {
    ...
    private fun drawHudCard(ctx: RenderContext) {
        ...
        if (!hudDiagLogged) {
            io.doppel.core.logging.CoreLogger.info("[Overlay] drawHudCard: ${entries.size} entries, font=${font::class.simpleName}, enabled=${HUD.enabled}")
            hudDiagLogged = true
        }
