...
object CoreLogger {
    ...
    /**
     * File sink — mirrors every log line to %TEMP%\doppel-agent.log so
    ...
    private val fileSink: java.io.PrintWriter? by lazy {
        try {
            ...
            java.io.PrintWriter(java.io.FileWriter(java.io.File(tmp, "doppel-agent.log"), true), true)
