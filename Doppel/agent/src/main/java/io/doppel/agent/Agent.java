...
import io.doppel.adapter.forge.v1_8_9.ForgeBootstrap;
import io.doppel.adapter.common.AgentBridge;
...
public class Agent {
    ...
    private static void initLogFile() {
        ...
        logFile = new File(tempDir, "doppel-agent.log");
        try {
    ...
    public static void agentmain(String agentArgs, Instrumentation inst) {
        initLogFile();
        log("[Doppel Agent] Attached to running JVM (args=" + agentArgs + ")");
    ...
    public static void premain(String agentArgs, Instrumentation inst) {
        initLogFile();
        log("[Doppel Agent] Loaded at JVM startup");
        coreInit(inst, detectConfigPath());
    }
    ...
    public static void bootstrap(String configDir) {
        initLogFile();
        log("========== Doppel Agent JNI Bootstrap ==========");
        ...
        String configPath = configDir + File.separator + "doppel-config.properties";
    ...
    private static void coreInit(Instrumentation inst, String configPath) {
        ...
        if (configPath != null) {
            ...
            if (configFile.exists()) {
                ...
                try (FileInputStream fis = new FileInputStream(configFile)) {
                    props.load(fis);
                    platform = props.getProperty("doppel.platform", "Unknown");
                    version = props.getProperty("doppel.version", "Unknown");
            ...
            try {
                ...
                while (cause != null) {
                    ...
                    for (StackTraceElement ste : cause.getStackTrace()) {
                        if (ste.getClassName().startsWith("io.doppel")) {
        ...
        //      to doppel-agent.log so the user can see exactly what failed.
        try {
            ...
            log("[Doppel Agent] Ready — tick active");
        } catch (Throwable t) {
            log("[Agent] ============================================================");
    ...
    private static String detectConfigPath() {
        ...
        if (classpath != null) {
            ...
            if (paths.length > 0) {
                ...
                if (jarDir != null) {
                    return jarDir + File.separator + "doppel-config.properties";
                }
            }
        }
        return null;
