...
object EventBridge {
    ...
    // Doppel-Tick background thread. Modules (background thread) only write
    ...
    @Volatile var desiredHitbox: io.doppel.core.model.Hitbox? = null
    ...
    fun drainDesiredRotationFrame(
        ...
        if (hitbox != null) {
            val aim = io.doppel.core.util.Vec2(currentYaw, currentPitch)
    ...
    private fun rotationCalculatorForAim() = io.doppel.core.algorithm.RotationCalculator
