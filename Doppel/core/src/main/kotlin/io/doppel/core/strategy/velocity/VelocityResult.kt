package io.doppel.core.strategy.velocity
 ...
 * [io.doppel.core.model.PlatformCommand]:
 *
...
sealed class VelocityResult {
     ...
     *
     * @param packetHandle the opaque handle from [io.doppel.core.model.VelocityContext.packetHandle].
     */
    data class Cancel(
